...
| Tool   | C++20 Modules | Info |
|--------|---------------|------|
| Qt moc | ⚙️ (6.12)      | **Update Sep 2026:** Qt 6.12 adds basic C++ modules support to moc. When moc'ing module interfaces and partitions, the generated cpp file is now made part of the respective module. `Q_OBJECT` & friends are still **not** supported in implementation units and private module fragments. There is still a lot of work to be done (tracked in [QTBUG-86697](https://bugreports.qt.io/browse/QTBUG-86697)), and most other Qt modules will likely need small fixes to work with modules as well. <br><br> As [abbapoh](https://www.reddit.com/user/abbapoh/) points out, modules have so far been tested with Qt Creator as a [proof of concept](https://codereview.qt-project.org/c/qt-creator/qt-creator/+/755635); there are currently no plans to add modules support to qtbase itself. The moc machinery has also been [back-ported to Qbs](https://codereview.qt-project.org/c/qbs/qbs/+/758007), so modules should work with older Qt versions when building with Qbs. The same could probably be done with CMake, although it requires knowing the includes in order to patch the generated file properly. <br><br> Background: the last mailing-list conversation happened mid December 2023 [here](https://lists.qt-project.org/pipermail/development/2023-December/044800.html), where fabiankosmale [laid out the challenges](https://lists.qt-project.org/pipermail/development/2023-December/044802.html). |
